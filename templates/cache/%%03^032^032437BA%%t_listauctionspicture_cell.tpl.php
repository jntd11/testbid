<?php /* Smarty version 2.6.18, created on 2012-05-19 08:46:11
         compiled from t_listauctionspicture_cell.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 't_listauctionspicture_cell.tpl', 8, false),array('modifier', 'date_format', 't_listauctionspicture_cell.tpl', 27, false),array('modifier', 'number_format', 't_listauctionspicture_cell.tpl', 78, false),array('function', 'infobullet', 't_listauctionspicture_cell.tpl', 154, false),)), $this); ?>
...
<?php endif; ?>
			...
			<input type="hidden" name="islogged" id="islogged" value="<?php echo $this->_tpl_vars['logged']; ?>
">
...
">
		  <input type="hidden" name="end_date<?php echo $this->_tpl_vars['current_row']->id; ?>
" id="end_date<?php echo $this->_tpl_vars['current_row']->id; ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['current_row']->end_date)) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m/%d/%Y %H:%M") : smarty_modifier_date_format($_tmp, "%m/%d/%Y %H:%M")); ?>
">
...
<?php endif; ?>"><?php echo $this->_tpl_vars['current_row']->gallery; ?>
			...
			<?php if ($this->_tpl_vars['current_row']->link_extern != ""): ?>
				...
				<input onclick="window.open('<?php echo $this->_tpl_vars['current_row']->link_extern; ?>
...
"><?php echo @auction_title; ?>
							...
							<a class="linkpicture" href="<?php if ($this->_tpl_vars['task'] == 'mybids'): ?><?php echo $this->_tpl_vars['current_row']->links['bid_list']; ?>
<?php else: ?><?php echo $this->_tpl_vars['current_row']->links['auctiondetails']; ?>
<?php endif; ?>"><span id="auctitle<?php echo $this->_tpl_vars['current_row']->id; ?>
...
"/>
        			...
        			<?php endif; ?>
						<input type="hidden" name="outbid<?php echo $this->_tpl_vars['current_row']->id; ?>
" id="outbid<?php echo $this->_tpl_vars['current_row']->id; ?>
" value="<?php echo $this->_tpl_vars['current_row']->outbid; ?>
">
...
" 
							 value="<?php if ($this->_tpl_vars['current_row']->proxyplus_price != ''): ?><?php echo $this->_tpl_vars['current_row']->proxyplus_price; ?>
...
" autocomplete="off" id="amount<?php echo $this->_tpl_vars['current_row']->id; ?>
" class="inputbox" onkeypress="return onlyNumbers(event);" type="text" value="" size="20" on alt="bid" <?php echo $this->_tpl_vars['disable_bids']; ?>
>&nbsp;
						<?php endif; ?>
					  </div>
					<?php endif; ?>
