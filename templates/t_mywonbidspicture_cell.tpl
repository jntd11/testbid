...
{* JaiEndB *}
	...
	{* JAIENDJ *}
					<td rowspan="4" valign="top">
						...
						{$current_row->currency_name}&nbsp;<input name="amount{$current_row->id}" autocomplete="off" id="amount{$current_row->id}" class="inputbox" type="text" value="" size="20" alt="bid" {$disable_bids}>&nbsp;
						</div>
						{/if}
