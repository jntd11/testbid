 ...
 *
 *  You don't need to do any checking on the files you work with - the class takes care of all error checking and you
 *  can find out what went wrong by reading the {@link error} property
 *
 ...
 *  @version    1.02 (last revision: August 12, 2006)
...
class imageTransform
{
    ...
    function resize()
    {
    	  // echo $sourceImageIdentifier;exit;
        ...
        if (list($sourceImageIdentifier, $sourceImageWidth, $sourceImageHeight) = $this->create_image_from_source_file()) {
            ...
            if ($this->maintainAspectRatio) {
                ...
                if (
                    ...
                    if ($this->resizeToHeight >= 0 && $targetImageHeight > $this->resizeToHeight )
                    {
                        // set the width of target image
